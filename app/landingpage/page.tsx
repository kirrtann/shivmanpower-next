...
const Landingpage = () => {
  ...
  if (!show) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2A356D]/80 min-h-screen">
      <div className="bg-white rounded-xl shadow-xl max-w-xl w-full p-8 sm:p-12 relative">
        <button
