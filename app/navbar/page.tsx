        ...
        <div className="max-w-[1250px] mx-auto py-[23px] px-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4 text-[15px] text-white">
            ...
            <Link
              ...
              prefetch={true}
              onClick={toggleMenu}
              className={`hover:bg-white rounded-md hover:text-[#466DA8] px-5 py-2 transition ${pathname === "/job" ? "bg-white text-[#466DA8] rounded-md" : ""}`}
            >
              Job Opening
            </Link>
            <Link
        ...
        >
          <ul className="px-4 pb-4 pt-2 w-[92%] mx-auto mt-2 rounded-xl shadow-md bg-[#466DA8] text-white space-y-2">
            ...
            <li>
              <Link
                href="/"
                className={`block py-3 px-4 text-xl rounded-md hover:bg-white hover:text-[#466DA8] transition ${pathname === "/" ? "bg-white text-[#466DA8] rounded-md" : ""
                  }`}
                onClick={toggleMenu}
                prefetch={true}
              >
            ...
            <li>
              ...
              <Link
                href="/services"
                className={`block py-3 px-4 text-xl rounded-md hover:bg-white hover:text-[#466DA8] transition ${pathname === "/services" ? "bg-white text-[#466DA8] rounded-md" : ""
                  }`}
                onClick={toggleMenu}
                prefetch={true}
              >
            ...
            <li>
              ...
              <Link
                href="/job"
                className={`block py-3 px-4 text-xl rounded-md hover:bg-white hover:text-[#466DA8] transition ${pathname === "/job" ? "bg-white text-[#466DA8] rounded-md" : ""
                  }`}
                onClick={toggleMenu}
                prefetch={true}
              >
            ...
            <li>
              ...
              <Link
                href="/contact"
                className={`block py-3 px-4 text-xl rounded-md hover:bg-white hover:text-[#466DA8] transition ${pathname === "/contact" ? "bg-white text-[#466DA8] rounded-md" : ""
                  }`}
                onClick={toggleMenu}
                prefetch={true}
              >
