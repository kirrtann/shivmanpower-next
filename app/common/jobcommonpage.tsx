                ...
                <div className="flex-1 bg-white  rounded-xl px-4">
                    <div className="flex items-center gap-4 mb-6 border-b pb-5">
                        ...
                        <div>
                            ...
                            <div className="text-gray-500 font-medium text-sm">{job.location}</div>
                            <div className="lg:flex  items-center gap-5 mt-1 text-black/70 font-semibold text-sm">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-black/70 text-sm font-bold ">{job.profile?.profiledecription}</p>
                    </div>
                    {/* Job Description */}
                    <div>
                        <h3 className="font-semibold mb-2">{job?.JobProfile?.JobProfile}</h3>
                        <ul className="list-disc pl-5 space-y-1 text-black/70 text-sm font-medium sm:leading-8 leading-7">
                ...
                <div className="w-full lg:w-[320px]">
                    ...
                    <div className="bg-white text-[13px] rounded-xl shadow border p-6 space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className=" text-[#1E1E1E] font-bold">Salary</div>
                                <div className="text-[#888888] font-medium">{job.overview?.salary}</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <LiaThumbtackSolid className={iconClass} />
                            <div>
                                <div className="text-[#1E1E1E] font-bold">Career Level</div>
                                <div className="text-gray-500 font-medium ">{job.overview?.careerLevel}</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <MdOutlineShield className={iconClass} />
                            <div>
                                <div className="text-[#1E1E1E] font-bold">Experience</div>
                                <div className="text-[#888888] font-medium">{job.overview?.experience}</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <div>
                            ...
                            <div>
                                <div className="text-[#1E1E1E] font-bold">Qualification</div>
                                <div className="text-[#888888] font-medium">{job.overview?.qualification}</div>
                            </div>
                        </div>
                    </div>
                </div>
